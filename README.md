...
Transformer Architectures: Swin Transformer (optimized for global context and long-range dependencies).
...
This system is built to evaluate the strengths of different neural architectures in a clinical setting:

Architecture

Models Included

Strength in Radiology

CNN

DenseNet, ResNet

Excellent at identifying local patterns like small nodules or fine fractures.

Transformer

Swin Transformer

Superior at capturing global anatomical relationships and complex structural dependencies in large CT volumes.
...
git clone [https://github.com/Divyansh010605/](https://github.com/Divyansh010605/)[your-repo-name].git
cd [your-repo-name]
